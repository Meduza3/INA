...
int main() {
    ...
    PyObject* module_name = PyUnicode_DecodeFSDefault("mymathloop");
    ...
    PyObject* factorial_args = PyTuple_Pack(1, PyLong_FromLong(5));
    ...
    PyObject* gcd_args = PyTuple_Pack(2, PyLong_FromLong(20), PyLong_FromLong(10));
    PyObject* gcd_result = PyObject_CallObject(gcd, gcd_args);
    Py_DECREF(gcd_args);

    if (gcd_result != NULL) {
        printf("Result of gcd(20, 10): %ld\n", PyLong_AsLong(gcd_result));
