...
main:
    ldr     r4, =#100        @ load 100 into r4 (loop limit)
...
isPrime:
    ...
    lsr     r5, r0, #1              @ r5 = (r0 >> 1), więc r5 = r0/2 logical shift right

    mov     r6, #2                  @ set the loop counter to 2
loop:
    cmp     r6, r5                  @ check if counter > n/2
    bgt     prime                   @ if r6 > r5, code checked all divisors up to n/2 so it must be prime
